...
urlpatterns = [
    ...
    path('printouts/score-sheet/download-pdf/', views.download_score_sheet_pdf, name='download_score_sheet_pdf'),
    ...
    path('printouts/merit-list/download-pdf/', views.download_merit_list_pdf, name='download_merit_list_pdf'),
    ...
    path('report/<int:student_id>/print-html/', views.individual_report_print_html, name='individual_report_print_html'),
    ...
    path('school-admin/classes/<int:grade_id>/streams/combine/', views.combine_streams, name='combine_streams'),
    path('school-admin/classes/<int:grade_id>/streams/split/', views.split_streams, name='split_streams'),
    path('school-admin/api/classes/<int:grade_id>/split-preview/', views.api_split_preview, name='api_split_preview'),
